...
public class PostDao {
	...
	public List<Post> retrieveAllUsersPosts() {
	...
	public List<Post> retrieveAllPosts() {
	    ...
	    /**
	     * this securityContextHolder will be useful to retrieve the current principal and pull the it is user name
	     * 
	   ...
	   if(principal instanceof UserDetails) {
	    ...
	    List<Post> query = session.createQuery("from Post").list();
	    
	   Iterator<Post> it = query.iterator();
