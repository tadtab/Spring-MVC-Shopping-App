...
public class UserController
{
 ...
 /* @Autowired
  ...
  public String register(@ModelAttribute AutoUser userModel, Model model){
	  String jspName = "";
	  List<AutoUser> allAutoUserList = userDAO.retieveExistingUsers();
	  /**
	  ...
	  for(AutoUser ExistingautoUser : allAutoUserList) {
		  if(ExistingautoUser.getUsername() != null &&
				  userModel.getUsername() != null &&
				  ExistingautoUser.getUsername().equals(userModel.getUsername())) {
